...
namespace utils
{
	namespace mem
	{
		...
		DWORD find_pattern_in_module(HMODULE module, std::string_view signature, DWORD offset = 0u, const char* description = nullptr);
		DWORD find_pattern(module_info& module, std::string_view signature, DWORD offset, const char* description = nullptr, bool is_active = true, DWORD inactive_offset = 0u);
		DWORD find_pattern_nearest(module_info& module, std::string_view signature, DWORD preferred_rva, DWORD offset, const char* description = nullptr, bool is_active = true, DWORD inactive_offset = 0u);
		std::vector<DWORD> find_pattern_matches(module_info& module, std::string_view signature, DWORD offset = 0u);
